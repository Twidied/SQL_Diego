...
BEGIN
  ...
  SELECT SUM (pp.cantidad * pp.precio_venta) INTO
...
//
CREATE EVENT ev_reporte _diario_ventas
ON SCHEDULE EVENT 1 DAY -- AT '2025-10-21 12:00:00'
  ...
  BEGIN
    ...
    INSERT INTO `Reportes`(`total`) VALUES();
  END
